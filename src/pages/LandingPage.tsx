    ...
    return (
        <div className="flex flex-col items-center">
            ...
            <form onSubmit={handleShorten} className="sm:h-14 flex flex-col sm:flex-row w-full md:w-2/4 gap-2">
                <Input type="url" value={longUrl} placeholder="Enter your loooong URL" className="h-full flex py-4 px-4" onChange={(e) => setLongUrl(e.target.value)} />
            ...
            <Accordion type="multiple" className="w-full md:px-11">
                <AccordionItem value="item-1">
                    <AccordionTrigger>
                        How does the TinyFox URL shortener works?
                    </AccordionTrigger>
                    <AccordionContent>
